...
<div class="container mt-10 z-40">
    ...
    <swiper-slide >
      ...
      <div class=" h-96 w-full bg-image" style="background:url(https://njrealestateschoolonline.com/images/slider/slider-1.jpg); background-repeat: no-repeat; background-size: cover; " > 
        ...
        <div class="absolute">
        <h2 class="text-white text-4xl font-extrabold">Call/Text (973) 314-4436 for details!</h2>
        <div class="flex gap-4 justify-center mt-8">  
        <a href="#" class="text-white px-6 py-2 text-md bg-primary border-primary hover:bg-primary-hover rounded-md">Course Schedule <i class="fas fa-chevron-right"></i> </a>
        <a href="#" class="text-black px-6 py-2 text-md bg-white border-white hover:bg-gray-300 rounded-md">Course Detail <i class="fas fa-chevron-right"></i> </a>
        </div>
        </div>
    </swiper-slide>
    ...
    <swiper-slide >
      <div class=" h-96 w-full bg-image" style="background:url(https://njrealestateschoolonline.com/images/slider/slider-2.jpg); background-repeat: no-repeat; background-size: cover; " > 
        ...
        <div class="absolute">
        <h2 class="text-white text-4xl font-extrabold">New Salesperson Course Nov. 7th!</h2>
        <div class="flex gap-4 justify-center mt-8">  
        <a href="#" class="text-white px-6 py-2 text-md bg-primary border-primary hover:bg-primary-hover rounded-md">Course Schedule <i class="fas fa-chevron-right"></i> </a>
        <a href="#" class="text-black px-6 py-2 text-md bg-white border-white hover:bg-gray-300 rounded-md">Course Detail <i class="fas fa-chevron-right"></i> </a>
        </div>
...
<section class="container w-full">
  <h2 class="flex justify-center text-5xl my-8 text-gray-600">Our Course Products</h2>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4  mx-auto place-items-center">

    <div class="p-4 bg-gray-200 rounded-md shadow-lg">
      <div class="h-60 w-80 ">
...
<br>
    <div class="bg-primary md:h-80 h-96  ">
        <div class="grid grid-cols-2 container mx-auto place-items-center">

            <div class="flex flex-col my-8 space-y-8"> 
              <h2 class="text-4xl text-white">Request A Callback</h2>
 ...
 <div class="flex flex-col my-8 space-y-8"> 
              ...
              <div class="grid grid-cols-2 gap-2">
                <input class="rounded-md" placeholder="First name" type ="text"/>
                <input class="rounded-md" placeholder="Last name" type ="text"/>
                <input class="rounded-md" placeholder="Phone" type ="text"/>
                <input class="rounded-md" placeholder="Email Address" type ="email"/>
              </div>

        <button  class="w-full py-2 mt-2 rounded-md bg-red-100">Submit</button>
    ...
    <div  class="bg-blue-300 py-4 footer-bg h-80 w-full">
        <div class="grid grid-cols-3 container mx-auto place-items-center items-start	">
      ...
      <a href="#"> <img src="https://njrealestateschoolonline.com/images/logo.png" class="w-80" /> </a>
            ...
            <div class="flex flex-col my-4 space-y-4 "> 
              <h2 class="text-3xl font-medium text-footer">Company</h2>
            ...
            <div class="flex flex-col my-4 space-y-4 "> 
              <h2 class="text-3xl font-medium text-footer">Contact us</h2>
              <div class="flex flex-col text-sm space-y-1">
...
.footer-bg:before { 
    background: url('footer-top.png') top center repeat-x;
    content: "";
    top: -73px;
    bottom: 0;
    left: 0;
